...
export default {
  ...
  setup() {
    ...
    const applySettings = (settingsObj) => {
      document.documentElement.style.setProperty('--primary-color', settingsObj.primary_color || '#0e7490');
      document.documentElement.style.setProperty('--secondary-color', settingsObj.secondary_color || '#3b82f6');
