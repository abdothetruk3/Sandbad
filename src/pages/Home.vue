        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 class="text-5xl lg:text-6xl font-bold leading-tight">
              {{ $t('hero.title') }} <span class="medical-text-gradient">{{ currentLocale === 'ar' ? 'سندباد' : 'Sandbad' }}</span>
            </h1>
    ...
    >
      <div class="text-center mb-12">
        ...
        <p class="text-gray-600 max-w-2xl mx-auto">
          Hear from our satisfied customers about their experiences with Sandbad Pharmacy.
        </p>
      </div>
    ...
    const testimonials = [
      {
        ...
        text: "I've been using Sandbad Pharmacy for all my medication needs. The delivery is always on time and the service is excellent!"
      },
      {
        name: "Michael Chen",
        avatar: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=100&h=100&q=80",
        text: "As someone with chronic health issues, I appreciate how easy Sandbad makes it to manage my prescriptions. Their customer service is top notch!"
      },
      {
        name: "Aisha Rahman",
        avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=100&h=100&q=80",
        text: "The range of products is impressive and the prices are very competitive. I've recommended Sandbad to all my family members."
      }
    ]
