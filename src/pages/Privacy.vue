  ...
  <div class="space-y-8">
    ...
    >
      ...
      <p class="text-gray-600 max-w-2xl">
        At Sandbad Pharmacy, we are committed to protecting your personal information and your right to privacy.
      </p>
    </div>
    ...
    >
      <div class="prose prose-lg max-w-none">
        <h2>Introduction</h2>
        <p>This Privacy Policy describes how Sandbad Pharmacy collects, uses, and shares your personal information when you use our website, mobile application, or visit our physical stores. By using our services, you agree to the terms of this Privacy Policy.</p>
