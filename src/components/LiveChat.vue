      ...
      >
        ...
        <div class="bg-primary text-white p-4 rounded-t-lg flex items-center justify-between">
          <div class="flex items-center">
            ...
            <div>
              <h3 class="font-medium">Sandbad Support</h3>
        ...
        <div 
          ...
          style="background-image: url('https://pattern.monster/static/ae6ebff8b3d911e11db4398ba52f8ced/piledup.svg'); background-size: 300px; background-color: #f8f9fa;"
        >
    ...
    const toggleChat = () => {
      ...
      if (isChatOpen.value) {
        ...
        if (messages.value.length === 0) {
          addBotMessage("👋 Welcome to Sandbad Pharmacy! How can I assist you today?")
