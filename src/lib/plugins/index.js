...
export const seoToolkitPlugin = {
  ...
  setup: (api) => {
    ...
    api.addFilter('page.metadata', (metadata, page) => {
      ...
      return {
        ...metadata,
        title: `${page.title} | Sandbad Pharmacy - Best Medications`,
        description: page.description || 'Find quality medications and healthcare products at Sandbad Pharmacy',
